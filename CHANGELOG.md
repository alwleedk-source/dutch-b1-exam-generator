...
## [Enhancement] 2025-11-04 - توحيد الـ header في جميع الصفحات

### المشكلة

رابط "امتحانات عامة" لا يظهر في بعض الصفحات:
- ❌ صفحة عرض الامتحان (exam_view.html)
- ❌ صفحة قائمة الكلمات (vocabulary.html)
- ❌ صفحة امتحاناتي (exams.html)

**النتيجة:** تجربة مستخدم غير متسقة

### الحل

إضافة رابط "امتحانات عامة" إلى جميع الصفحات لتوحيد الـ header.

### التغييرات

تم تحديث الـ navigation في:

1. **static/exam_view.html**
2. **static/vocabulary.html**
3. **static/exams.html**

**الترتيب الموحد الآن:**
1. الرئيسية
2. امتحاناتي
3. **امتحانات عامة** ← جديد!
4. قائمة كلماتي

### النتيجة المتوقعة

- ✅ Header موحد في جميع الصفحات
- ✅ رابط "امتحانات عامة" متاح من أي صفحة
- ✅ تجربة مستخدم متسقة
