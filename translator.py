...
- تجاهل **فقط** الكلمات التالية: de, het, een, en, of, maar, want, is, zijn, was, waren
- ترجم **جميع** الكلمات الأخرى بما فيها:
  * جميع الأسماء (gemeente, cursus, bewoner, etc.)
  * جميع الأفعال (organiseert, begint, duurt, etc.)
  * جميع الصفات (gratis, nieuwe, beperkt, etc.)
  * الظروف المهمة (elke, via, tot, etc.)
  * حروف الجر المهمة (voor, op, in, met, etc.)
- إذا كانت الكلمة لها معانٍ متعددة، اختر المعنى المناسب للسياق
- **الهدف**: ترجمة أكبر عدد ممكن من الكلمات لمساعدة الطالب
